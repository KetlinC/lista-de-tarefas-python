...
- Uso de listas para armazenamento e manipulação de dados
- Criação e organização de funções para modularizar o código
- Estruturas de repetição (`while` e `for`)
- Estruturas condicionais (`if`, `elif`, `else`)
- Interação com o usuário por meio de entradas (`input`) e saídas (`print`)
- Manipulação de strings (uso do método `.lower()`)
- Lógica para validação de dados e tratamento de casos como lista vazia
- Organização de um projeto simples e publicação no GitHub
...
```bash
git clone https://github.com/KetlinC/lista-de-tarefas-python.git
```
